...
1. Clone the repo
   ```sh
   git clone https://github.com/zoumson/GraphicalInterfaces.git
   ```
2. Go to the project directory source
   ```sh
   cd GraphicalInterfaces
   ```
...
Project Link: [https://github.com/zoumson/GraphicalInterfaces](https://github.com/zoumson/GraphicalInterfaces.git)
